...
set( QT_INSTALL_PLUGINS_PLATFORMS
    ${QT_DIR}/../plugins/platforms/qwindows.dll
)

set( QT_INSTALL_PLUGINS_IMAGEFORMATS
    ${QT_DIR}/../plugins/imageformats/qsvg.dll
)

install( FILES ${QT_INSTALL_DLLS} DESTINATION . )
install( FILES ${QT_INSTALL_PLUGINS_PLATFORMS} DESTINATION ./platforms )
install( FILES ${QT_INSTALL_PLUGINS_IMAGEFORMATS} DESTINATION ./imageformats )

file( COPY ${QT_INSTALL_DLLS} DESTINATION ${PROJECT_BINARY_DIR} )
file( COPY ${QT_INSTALL_PLUGINS_PLATFORMS} DESTINATION ${PROJECT_BINARY_DIR}/platforms )
file( COPY ${QT_INSTALL_PLUGINS_IMAGEFORMATS} DESTINATION ${PROJECT_BINARY_DIR}/imageformats )
